  ...
  return (
    <label
      className={`flex items-center transition-all 
                border-light-gray rounded-large px-4 
                py-3 border-[1px] mb-3 peer-checked:bg-very-light-gray
                 cursor-pointer peer-checked:border-purple text-body-s 
    ...
    >
      <input
        checked={isAdded}
        type="checkbox"
        className="appearance-none transition-colors w-[20px] h-[20px]
         border-light-gray border-[1px] rounded-small
          focus:border-purple checked:border-purple 
          checked:bg-purple checked:bg-checkmark checked:bg-no-repeat 
          checked:bg-center shrink-0 cursor-pointer"
